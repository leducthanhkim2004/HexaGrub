...
export default function AppetizersPage() {
  ...
  useEffect(() => {
    async function loadAppetizers() {
      const items = await menuService.getMenuItemsByCategory('appetizers');
      ...
      <div className="min-h-screen">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-center h-96">
            <div className="text-2xl text-gray-600">Loading appetizers...</div>
          </div>
        </main>
      </div>
    );
      ...
      <section className="relative py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-5xl font-black text-black mb-6">Delightful Appetizers</h1>
      ...
      {selectedItem && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="p-6">
              <h2 className="text-3xl font-extrabold text-gray-900 mb-4 drop-shadow-sm">{selectedItem.name}</h2>
