      ...
      <div className="min-h-screen">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-center h-96">
            <div className="text-2xl text-gray-600">Loading desserts...</div>
          </div>
        </main>
      </div>
    );
      ...
      <section className="relative py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-5xl font-black text-black mb-6">Sweet Delights</h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Indulge in our selection of traditional Vietnamese desserts and sweet treats,
              perfect for ending your meal on a sweet note.
            </p>
          </div>
        </div>
      </section>

      {/* Desserts Listing Section */}
