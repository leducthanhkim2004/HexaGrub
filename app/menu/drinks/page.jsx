      ...
      <div className="min-h-screen">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-center h-96">
            <div className="text-2xl text-gray-600">Loading drinks...</div>
          </div>
        </main>
      </div>
    );
      ...
      <section className="relative py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-5xl font-black text-black mb-6">Refreshing Beverages</h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Discover our selection of traditional Vietnamese drinks and modern beverages,
              perfect for complementing your meal or enjoying on their own.
            </p>
          </div>
        </div>
      </section>

      {/* Drinks Listing Section */}
              ...
              <div key={item.id}>
                <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-gray-200">
                  ...
                  <div className="p-6 h-48 flex flex-col justify-between bg-white">
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900 mb-3 drop-shadow-sm">{item.name}</h3>
                      <p className="text-gray-700 mb-4">{item.description}</p>
                    </div>
                    <div className="flex justify-between items-center mt-auto">
                      <span className="text-xl font-bold text-gray-900 drop-shadow-sm">${item.price.toFixed(2)}</span>
                      <button
          ...
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-hidden border border-gray-300 shadow-lg">
            ...
            <div className="p-6 bg-white">
              ...
              <div className="flex justify-between items-center">
                <span className="text-2xl font-bold text-gray-900 drop-shadow-sm">${selectedItem.price.toFixed(2)}</span>
                <button
                  onClick={() => {
                    addToCart(selectedItem);
                    closeModal();
                  }}
                  className="inline-block px-6 py-3 border-2 border-black bg-black text-white font-medium hover:bg-gray-800 transition-all duration-300"
                >
                  Add to Cart
                </button>
              </div>
