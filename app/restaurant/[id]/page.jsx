        ...
        <div className="mb-8 flex flex-wrap gap-4">
          <div className="flex-1 min-w-[200px]">
            <input
              ...
              className="w-full px-4 py-3 text-lg font-medium text-gray-800 border-2 border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm"
            />
          </div>
          <div className="w-48">
            <select
